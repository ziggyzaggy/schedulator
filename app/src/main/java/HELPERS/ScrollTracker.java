...
/**
 * Created by cogentapps on 18/02/2015.
 * kindly borrowed from from gist https://gist.github.com/cogentapps/6680353
 */
public class ScrollTracker {
    ...
    public ScrollTracker(final AbsListView listView){
        mListView = listView;
    }
